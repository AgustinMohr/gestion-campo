...
import os  # Asegurate de tener esto al principio del settings.py

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, 'templates'),  # Ruta global para base.html
        ],
        'APP_DIRS': True,  # Habilita búsqueda automática en cada /templates/ de las apps
        'OPTIONS': {
            'context_processors': [
